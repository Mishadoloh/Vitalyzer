# Metrivyn (Next.js + TypeScript + PostgreSQL + Google Auth + Stripe)

Metrivyn — багатокористувацький SaaS: "розумний шар" над вашими даними сну/тренувань/харчування/ваги/настрою. Користувачі входять через Google, оформлюють підписку і отримують доступ до дашборду, який аналізує тренди й видає щоденну персональну пораду. Повністю адаптивний інтерфейс — працює як на десктопі, так і з телефону.
...
Заповніть змінні, описані в розділах нижче.
...
- **Налаштування** — керування підпискою (Stripe Billing Portal), особисті цілі, розсилка, резервні копії та вихід з акаунту.
