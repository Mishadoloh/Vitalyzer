...
export const metadata: Metadata = {
  ...
  description: 'Як Vitalyzer обробляє та захищає дані користувачів.',
};
      ...
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-9 text-[15px] leading-7 text-text-muted">
          <section>
            ...
            <p className="mt-2">Після входу через Google Vitalyzer отримує базові дані профілю: ім’я, email та фото. Застосунок також зберігає записи, які ви додаєте або імпортуєте: сон, тренування, харчування, вагу, настрій, цілі, звички та приватні фото прогресу.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="mt-2">У налаштуваннях можна експортувати дані, скинути застосунок і видалити записи. Доступ Vitalyzer до Google-акаунта можна відкликати у налаштуваннях безпеки Google.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-text">Зв’язок</h2>
            <p className="mt-2">Питання щодо конфіденційності можна надіслати через <a className="text-accent hover:underline" href="https://github.com/Mishadoloh/Vitalyzer/issues">репозиторій Vitalyzer</a>.</p>
          </section>
        </div>
      </article>
    </main>
